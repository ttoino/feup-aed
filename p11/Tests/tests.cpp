...
TEST(test1, dijkstra_path) {
    ...
    Graph g1 = FunWithGraphs::graph1();
    ans = {1, 4, 5, 2};
    EXPECT_EQ(ans, g1.dijkstra_path(1, 2));
    ans = {2, 5, 4, 1};
    EXPECT_EQ(ans, g1.dijkstra_path(2, 1));
    ans = {1, 4, 5};
    EXPECT_EQ(ans, g1.dijkstra_path(1, 5));
    ans = {5, 4, 1};
    EXPECT_EQ(ans, g1.dijkstra_path(5, 1));
    ans = {1, 4, 6, 3};
    EXPECT_EQ(ans, g1.dijkstra_path(1, 3));
    ans = {3, 6, 4, 1};
    EXPECT_EQ(ans, g1.dijkstra_path(3, 1));
    ans = {1, 4, 6, 7};
    EXPECT_EQ(ans, g1.dijkstra_path(1, 7));
    ans = {7, 6, 4, 1};
    EXPECT_EQ(ans, g1.dijkstra_path(7, 1));
    ans = {4, 6, 3};
    EXPECT_EQ(ans, g1.dijkstra_path(4, 3));
    ans = {3, 6, 4};
    EXPECT_EQ(ans, g1.dijkstra_path(3, 4));
    ans = {4, 5, 2};
    EXPECT_EQ(ans, g1.dijkstra_path(4, 2));
    ans = {2, 5, 4};
    EXPECT_EQ(ans, g1.dijkstra_path(2, 4));

    cout << "  . graph2" << endl;
    Graph g2 = FunWithGraphs::graph2();
    ans = {1, 5, 6, 9};
    EXPECT_EQ(ans, g2.dijkstra_path(1, 9));
    ans = {9, 6, 5, 1};
    EXPECT_EQ(ans, g2.dijkstra_path(9, 1));
    ans = {1, 5, 6, 3};
    EXPECT_EQ(ans, g2.dijkstra_path(1, 3));
    ans = {3, 6, 5, 1};
    EXPECT_EQ(ans, g2.dijkstra_path(3, 1));
    ans = {2, 6, 3};
    EXPECT_EQ(ans, g2.dijkstra_path(2, 3));
    ans = {3, 6, 2};
    EXPECT_EQ(ans, g2.dijkstra_path(3, 2));
    ans = {6, 5, 8};
    EXPECT_EQ(ans, g2.dijkstra_path(6, 8));
    ans = {8, 5, 6};
    EXPECT_EQ(ans, g2.dijkstra_path(8, 6));

    cout << "  . graph3" << endl;
    Graph g3 = FunWithGraphs::graph3();
    ans = {};
    EXPECT_EQ(ans, g3.dijkstra_path(8, 11));
    ans = {11, 6, 4, 3, 2, 1, 7, 8};
    EXPECT_EQ(ans, g3.dijkstra_path(11, 8));
    ans = {3, 2, 1, 7, 8};
    EXPECT_EQ(ans, g3.dijkstra_path(3, 8));
    ans = {8, 4, 3};
    EXPECT_EQ(ans, g3.dijkstra_path(8, 3));
    ans = {10, 5};
    EXPECT_EQ(ans, g3.dijkstra_path(10, 5));
    ans = {5, 4, 3, 2, 1, 7, 9, 10};
    EXPECT_EQ(ans, g3.dijkstra_path(5, 10));
    ans = {10, 6, 4};
    EXPECT_EQ(ans, g3.dijkstra_path(10, 4));
    ans = {};
    EXPECT_EQ(ans, g3.dijkstra_path(6, 11));
    ans = {};
    EXPECT_EQ(ans, g3.dijkstra_path(1, 11));
}
