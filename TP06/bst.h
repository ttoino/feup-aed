...
public:
    ...
    int size(const Comparable &el); // new
};
...
template <class Comparable>
Comparable &BST<Comparable>::find(const Comparable &x) {
...
template <class Comparable>
Comparable &BST<Comparable>::elementAt(BinaryNode<Comparable> *t) {
    if (t == NULL)
...
public:
    ...
    iteratorBST<Comparable> &operator++();
...
iteratorBST<Comparable> iteratorBST<Comparable>::operator++(int) {
    iteratorBST<Comparable> temp{*this};
...
template <class Comparable>
iteratorBST<Comparable> &iteratorBST<Comparable>::operator++() {
    BinaryNode<Comparable> *actual = itrStack.top();
    itrStack.pop();
    BinaryNode<Comparable> *next = actual->right;
    if (next)
