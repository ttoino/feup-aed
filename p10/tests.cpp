...
TEST(test2, game) {
    ...
    EXPECT_EQ(734, FunWithGraphs::game(
                       {799, 285, 977, 440, 587, 996, 652, 509, 162, 57}));
    EXPECT_EQ(4541040, FunWithGraphs::game({655712, 222346, 79323522, 6425631,
                                            14893716, 42424242, 23456789}));
}
...
TEST(test6, gridCity) {
    ...
    vector<pair<int, int>> houses1 = {{1, 1}, {3, 4}, {3, 6},
                                      {5, 5}, {6, 3}, {6, 6}};
    ...
    vector<pair<int, int>> houses2 = {{1, 1}, {2, 2}, {2, 1}, {2, 4},
                                      {1, 5}, {3, 3}, {4, 4}, {5, 5}};
    EXPECT_EQ(12, FunWithGraphs::gridCity(plants2, houses2));

    vector<pair<int, int>> plants3 = {{18, 50}, {81, 38}, {8, 8}, {66, 33}};
    vector<pair<int, int>> houses3 = {{81, 3},  {17, 62}, {79, 57}, {10, 56},
                                      {48, 80}, {86, 90}, {30, 73}, {9, 7},
                                      {6, 96},  {66, 24}, {34, 18}, {96, 12}};
